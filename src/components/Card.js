...
export default function Card(props) {
	...
	return ( <
		...
		alt = "stew"
		className = "w-full h-35  object-fill sm:h-48 " / >
		<
		div className = "m-4" >
		<
		...
		<
		select className = "m-4 h-100 bg-red-500 rounded text-white"
		onChange = {
		...
		/select> <
		select className = "m-2 h-100 bg-red-500 rounded text-white"
		ref = {
			priceRef
		}
		onChange = {
		...
		<
		button className = "m-4 h-100 p-1 text-red-500 hover:shadow hover:border-red-500  hover:bg-red-500 hover:text-white rounded"
		onClick = {
			handleaddCart
		}
		style = {
